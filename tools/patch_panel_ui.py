...
<div class="hp-dashboard-toolbar"><div aria-live="polite" class="dashboard-state" id="dashboardState" role="status"><span id="dashboardUpdated">Waiting for first update…</span><span class="error" hidden="" id="dashboardError"></span><button class="btn sm" data-i18n="ui.refresh" id="dashboardRetry" type="button">Refresh</button></div></div>
